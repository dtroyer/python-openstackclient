...
class CreateImage(show.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        # TODO(dtroyer): validate the remaining options for a v2 create,
        #                they are not listed in the API spec
        ...
        parser.add_argument(
            ...
            help=(
                "Image container format (default: %s)"
        ...
        parser.add_argument(
            ...
            metavar="<disk-format>",
            help=(
                "Image disk format (default: %s)" % DEFAULT_DISK_FORMAT
            ),
        )
        parser.add_argument(
            "--owner",
        ...
        parser.add_argument(
            ...
            help=(
                "Image size, in bytes "
                "(only used with --location and --copy-from)"
            ),
        )
        parser.add_argument(
            "--min-disk",
        ...
        protected_group.add_argument(
            ...
            action="store_true",
            default=False,
            help="Allow images to be deleted (default)",
        )
        parser.add_argument(
            "--property",
            dest="properties",
...
class UnsetImage(command.Command):
    ...
    log = logging.getLogger(__name__ + '.UnsetImage')
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "(repeat to unset multiple properties)"
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.property:
            image = image_client.images.update(
                image.id,
                remove_props=parsed_args.property,
            )
        else:
